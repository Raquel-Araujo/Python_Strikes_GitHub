...
outputdir = '../output/montages/montagesFigure1/'
# output= outputdir +'strike3.png'
...
#### roda a funcao
#aqui tinha modificado a função para retirar o titulo
func.make_mult_fig(objimg, size, grid, output, deltatime, imgextent, strikesel, gapstrike, dateimg)
